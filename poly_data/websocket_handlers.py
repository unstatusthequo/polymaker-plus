...
async def connect_market_websocket(chunk):
    ...
    async with websockets.connect(
        uri,
        ping_interval=5,
        ping_timeout=10,  # Timeout after 10 seconds without pong response
        ...
        try:
            ...
            while True:
                # Add timeout to recv() to prevent hanging indefinitely
                try:
                    ...
                    print("Market websocket recv timeout, checking connection...")
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    print("User websocket recv timeout, checking connection...")
                    # Send a ping to check if connection is alive
                    await websocket.ping()
        except websockets.ConnectionClosed:
